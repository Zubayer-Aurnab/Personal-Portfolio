            ...
            <div className="w-4/5 mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 text-white ">
                <Slide left>
                    ...
                    <div >
                        ...
                        <progress className="progress" value="60" max="100" >
                            <style>{`.progress::-webkit-progress-value {background-color: #bcfd49;`}</style>
                        </progress>
                    </div>
                </Slide>
                <Slide right>
                ...
                <Slide right>
                    ...
                    <div >
                        ...
                        <progress className="progress  w-full " value="35" max="100"></progress>
                    </div>
                </Slide>
                <Slide left>
                    {/* 3 */}
                ...
                <Slide left>
                    ...
                    <div >
                        ...
                        <progress className="progress  w-full -spacing-2 " value="90" max="100"></progress>
                    </div>
                </Slide>
                <Slide right >
                    {/* 8*/}
