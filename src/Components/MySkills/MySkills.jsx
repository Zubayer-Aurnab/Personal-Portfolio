        ...
        <div>
            ...
            <div className="w-4/5 mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 text-white ">
                <Slide left>
                    {/* 0 */}
                    <div >
                        <div className="p-4 lg:p-10 bg-slate-700 flex items-center gap-4 rounded-xl">
                ...
                <Slide right>
                    {/* 4*/}
                    <div >
                        <div className="p-1 px-4 lg:p-8 bg-slate-700 flex items-center gap-4 rounded-xl">
